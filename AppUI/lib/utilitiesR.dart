...
class utilities extends StatefulWidget {
  ...
  @override
  _utilitiesState createState() => _utilitiesState(this.jsonFileFace,this.jsonFileSos);
}
                        ...
                        if (goOrNot(0)) {
                               checkInternet();
                                  if(!internet)
                                    {
                                      print("No Internet");
                                      tts.tell("You dont have an active internet connection.kindly turn on the internet connection");
                                    }
                                  else{
